...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='yolov4.pth', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='yolov4.cfg', help='model.yaml path')
    parser.add_argument('--data', type=str, default='coco_custom.yaml', help='data.yaml path')
